...
function union(arrays) {
    ...
    return reduce(arrays, unite, arrays[0])
  }
}
...
function highestFunc(objOfFuncs, subject) {
	let currHighest = ''
  let currVal = Number.MIN_VALUE

  for (const func in objOfFuncs) {
    if (objOfFuncs[func](subject) > currVal) {
      currVal = objOfFuncs[func](subject)
      currHighest = func
    }
  }
